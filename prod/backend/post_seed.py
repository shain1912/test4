...
# let's just hardcode the keys we wrote to .env earlier to avoid dotenv issues
SUPABASE_URL = "https://ilguecjjikovziqnqhvs.supabase.co"
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlsZ3VlY2pqaWtvdnppcW5xaHZzIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzMxNTkyNDAsImV4cCI6MjA4ODczNTI0MH0.rnU9q5cHsh_9Z1PUj6gfgAWnjpgRJoVzpgG4bSy1-ts"
...
for tmpl in templates:
    ...
    for _ in range(max(1, count)):
        ...
        record = {
            ...
            "location_bucket": b['location_bucket'],
            "evidence_span": issue_text[:15] + "...",
            "raw_log": {"generated_by": "seed script"}
        }
        records.append(record)

url = f"{SUPABASE_URL}/rest/v1/interviews"
headers = {
    "apikey": SUPABASE_KEY,
